                ...
                case "A" -> {
                    ...
                    addNewAccountLoop: while (!isDone) {
                        ...
                        if (bank.addNewAccount(account)) {
                            System.out.println("Added successfully: " + account);
                        }
                        isDone = true;
                    }
                            ...
                            try {
                                ...
                                if (amount > 0) {
                                    ...
                                    if (bank.addTransaction(transaction)) {
                                        System.out.println("Transaction successfully: Deposited $" + amount);
                                        isAmountValid = true;
                                    }
                                } else {
                            ...
                            try {
                                ...
                                if (amount > 0) {
                                    ...
                                    if (bank.validateWithdraw(amount, accountNumber)) {
                                        if (bank.addTransaction(transaction)) {
                                            System.out.println("Transaction successfully: Withdrew $" + amount);
                                            isAmountValid = true;
                                        }
                                    } else {
                                        System.out.println("Transaction failed: Balance is not sufficient");
                                    }
                                } else {
                                    System.out.println("Amount must be greater than 0");
                                }
